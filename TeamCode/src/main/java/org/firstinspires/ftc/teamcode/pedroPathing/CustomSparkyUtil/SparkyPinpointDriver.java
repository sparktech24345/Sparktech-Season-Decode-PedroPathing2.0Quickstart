...
public class SparkyPinpointDriver extends I2cDeviceSynchDevice<I2cDeviceSynchSimple> {
     ...
     * is supported.
     *
     * @param data SparkyPinpointDriver.ReadData.ONLY_UPDATE_HEADING
     */
    ...
    public float getXOffset(DistanceUnit distanceUnit) {
        return (float) - distanceUnit.fromMm(readFloat(SparkyPinpointDriver.Register.X_POD_OFFSET)); /// TODO HERE
    }
