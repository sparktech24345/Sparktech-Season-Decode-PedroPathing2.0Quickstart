...
public class DriveTrain {
    ...
    public void loop() {
        ...
        RFDrive.setPower(FrontRightPow * slowdownConstant);
        LFDrive.setPower(FrontLeftPow * slowdownConstant);
        RBDrive.setPower(BackRightPow * slowdownConstant);
        LBDrive.setPower(BackLeftPow * slowdownConstant);
    }
