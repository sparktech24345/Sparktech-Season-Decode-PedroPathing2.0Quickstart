...
public class TeleOPasyncUpdates {
    ...
    public static AtomicReference<Double> turretTargetAngle = new AtomicReference<>(0.0);
    public static AtomicReference<Double> turretTargetVelocity = new AtomicReference<>(0.0);
    public static AtomicReference<Double> turretTargetRotation = new AtomicReference<>(0.0);

    public static AtomicBoolean turretTargetAngleOverride = new AtomicBoolean(false);
    public static AtomicBoolean turretTargetVelocityOverride = new AtomicBoolean(false);
    public static AtomicBoolean turretTargetRotationOverride = new AtomicBoolean(false);
